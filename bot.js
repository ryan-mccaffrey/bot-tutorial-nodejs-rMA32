...
var checkCommandsHSH = [mods, sysTriggers, userCmds, userMentions, sysCommands, atEveryone, funCommands, quotes, rooms, gif];
...
exports.respond = function(botRoom) {
  ...
  var dataHash = {
    ...
    isMod:        mods.isMod(request.user_id, config.env().owner),
    bots:         rooms.getRooms(),
